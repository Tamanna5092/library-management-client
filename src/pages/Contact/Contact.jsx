...
const Contact = () => {
  const markers = [
    {
      geocode: [23.8103, 90.4125],
      popup: "Book Sphere - Dhaka Central",
    },
    {
      geocode: [23.7806, 90.2792],
      popup: "Book Sphere - Uttara",
    },
    {
      geocode: [23.7465, 90.376],
      popup: "Book Sphere - Dhanmondi",
    },
  ];
    ...
    <section className=" bg-white dark:bg-gray-900">
      <div className="container py-12 mx-auto">
        <div className="max-w-7xl mx-auto lg:flex lg:items-center">
          <div class="px-4 md:px-0 lg:w-1/2 animate__animated animate__fadeInLeft lg:mx-6">
            ...
            <div class="mt-6 space-y-8 md:mt-8">
              <p class="flex items-start -mx-2">
                <svg
                  ...
                  class="w-6 h-6 mx-2 text-[#FF5722] dark:text-blue-400"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  stroke-width="2"
            ...
            <div class="mt-6 w-80 md:mt-8">
              ...
              <div class="flex mt-4 -mx-1.5">
                <a
                  class="mx-1.5 dark:hover:text-blue-400 text-gray-400 transition-colors duration-300 transform hover:text-[#FF5722] hover:animate-ping"
                  href="#"
                >
                  <svg
          ...
          <div class="mt-8 animate__animated animate__fadeInRight lg:w-1/2 lg:mx-6">
            <div class="w-full px-8 py-10 mx-auto overflow-hidden bg-white rounded-lg shadow-2xl dark:bg-gray-900 lg:max-w-xl shadow-gray-300/50 dark:shadow-black/50">
              ...
              <form class="mt-6">
                ...
                <button class="w-full px-6 py-4 mt-6 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform rounded-md bg-black border-none hover:bg-[#FF5722]">
                  get in touch
                </button>
              </form>
            </div>
